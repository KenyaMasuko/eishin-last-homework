    ...
    <div class="py-6 px-8 ml-56 text-white">
        ...
        <div class="mt-6 relative overflow-x-auto flex gap-5">
            ...
            <div
                ...
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $offer->title }}
                </h5>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $offer->companyInfo->name }}</p>
