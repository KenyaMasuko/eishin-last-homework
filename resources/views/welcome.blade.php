    ...
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="{{ route('admin-login') }}"
                class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">管理者でログイン</a>
            <a href="{{ route('company-login') }}"
                class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">企業でログイン</a>

            @if (Route::has('register'))
            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">ユーザー登録</a>
            <a href="{{ route('admin-register') }}"
                class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">管理者を追加</a>
            <a href="{{ route('company-register') }}"
                class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">企業を登録</a>
            @endif
            @endauth
        </div>
        @endif
