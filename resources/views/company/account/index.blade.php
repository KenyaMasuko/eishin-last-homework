<x-app-layout>
    <div class="py-6 px-8 ml-56 text-white">
        <div class="flex items-center justify-between">
            <h1 class="text-4xl font-extrabold dark:text-white">アカウント一覧</h1>
            <a href="{{ route('company.account.create') }}"
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 flex items-center gap-4">
                            <a href="{{ route('company.account.edit', $account->id) }}"
                            ...
                            <form action="{{ route('company.account.destroy', $account->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
